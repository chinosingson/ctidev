...
<form name="form-add-project" id="form-add-project">
	...
	<div class="form-horizontal" role="form" style="overflow-x: hidden">
		...
		<div class="form-group form-group-sm row">
			...
			<div class="col-xs-9"><input type="date" class="form-control" id="project-start" name="data[start]" placeholder="MM/DD/YYYY" /></div>
		</div>
		<div class="form-group form-group-sm row">
			<div class="col-xs-3"><label for="project-end" class="control-label">End</label></div>
			<div class="col-xs-9"><input type="date" class="form-control" id="project-end" name="data[end]" placeholder="MM/DD/YYYY" /></div>
		</div>
		<div class="form-group form-group-sm row">
