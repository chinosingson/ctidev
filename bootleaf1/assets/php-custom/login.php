<?php 
	...
	//if (isset($_SESSION)){
		...
		echo '<button id="btn-log-out" onclick="$(\'#btn-log-out\').tooltip(\'destroy\');" type="button" class="btn btn-sm btn-default" data-toggle="tooltip" data-placement="top" title="Sign out of CTI Mapping Tool">Log Out</button>';
	} else { ?><form class='form-horizontal' method="post" role='form' name='login' id='user-login'>
						<div class="row">
						...
						<div class="jumbotron-links">
							<a href="./assets/UserFrosting/forgot_password.php">Forgot your password?</a>
