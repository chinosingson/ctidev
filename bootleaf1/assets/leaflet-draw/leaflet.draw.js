...
!function (t, e) {
	...
	L.Draw.Rectangle = L.Draw.SimpleShape.extend({
			...
			_getTooltipText : function () {
				...
				a = this._shape;
				return a && (t = this._shape.getLatLngs(), e = L.GeometryUtil.geodesicArea(t), i = L.GeometryUtil.readableArea(e, this.options.metric)), {
					text : o.text,
					subtext : i
				}
			}
	...
	L.EditToolbar = L.Toolbar.extend({
			...
			initialize : function (t) {
				t.edit && ("undefined" == typeof t.edit.selectedPathOptions && (t.edit.selectedPathOptions = this.options.edit.selectedPathOptions), t.edit.selectedPathOptions = L.extend({}, this.options.edit.selectedPathOptions, t.edit.selectedPathOptions)),
	...
	L.EditToolbar.Edit = L.Handler.extend({
			...
			_toggleMarkerHighlight : function (t) {
				if (t._icon) {
					...
					// changed by JPS 2014-12-08
					L.DomUtil.hasClass(e, "leaflet-edit-marker-selected") ? (L.DomUtil.removeClass(e, "leaflet-edit-marker-selected"), this._offsetMarker(e, 0)) : (L.DomUtil.addClass(e, "leaflet-edit-marker-selected"), this._offsetMarker(e, 0)),
					e.style.display = ""
				}
			},
