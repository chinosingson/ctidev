L.Control.Sidebar = L.Control.extend({
    ...
    close: function() {
		...
		// adapted from leaflet sidebar 0.1.5 isVisible function
		// added by JPS 2014-10-07
    isOpen: function () {
        return L.DomUtil.hasClass(this._container, 'active');
    },

		// adapted from leaflet sidebar 0.1.5 toggle function
		// added by JPS 2014-10-09
    toggle: function () {
        if (this.isOpen()) {
            this.open();
        } else {
