  ...
  <body>
    <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      ...
      <div class="navbar-collapse collapse">
        <ul class="nav navbar-nav">
          <li><!-- Login -->
						<a href="#" data-toggle="collapse" data-target=".navbar-collapse.in" onclick="$('#loginModal').modal('show'); return false;"><i class="fa fa-user" style="color: white"></i>&nbsp;&nbsp;Login</a>
					</li><!-- Login -->
					
					<li class="dropdown"><!-- Database -->
					...
					<li><!-- Monitor -->
						<a href="#" onclick="$('#monitorModal').modal('show'); return false;"><i class="fa fa-tasks" style="color: white"></i>&nbsp;&nbsp;Monitor</a>
					</li><!-- Monitor -->
					
					<!--li><a href="#" onclick="sidebar.hide(); sidebarMap.hide(); sidebarMonitor.toggle(); return false;">Monitor</a></li-->
					
					<li><!-- Help -->
						<a href="#"><span class="glyphicon glyphicon-question-sign" style="color: white"></span>&nbsp;&nbsp;Help</a>
					</li><!-- Help -->
        </ul>
    ...
    <div id="map"></div>
        ...
        <div class="panel panel-default" style="margin: 0px; border: none; border-radius: 0px; -webkit-box-shadow: none; box-shadow: none;">
            ...
            <h2 class="panel-title" style="display: inline;"><b>Map View</b><button type="button" class="btn btn-xs btn-default pull-right" onclick="sidebar.show(); sidebarMap.hide(); return false;"><i class="fa fa-chevron-right"></i></button></h2>
					</div>
    ...
    <div id="sidebar">
      <div class="sidebar-wrapper">
        <div class="panel panel-default" style="margin: 0px; border: none; border-radius: 0px; -webkit-box-shadow: none; box-shadow: none;">
          <div class="panel-heading">
            <h2 class="panel-title" style="display: inline;"><b>Database View</b><button type="button" class="btn btn-xs btn-default pull-right" onclick="sidebar.hide();"><i class="fa fa-chevron-left"></i></button></h2>
          </div>
          <div class="panel-body">
            <!-- Nav tabs -->
                  ...
                  <table class="table table-hover" id="projects-table">
                    ...
                    <tbody class="list">
							...
							<div class="tab-pane fade" id="projects-edit">
								...
								<div class="form-horizontal" role="form" style="display: table-row-group; overflow: auto" id="project-forms">
									<?//php include='./assets/php-custom/database-edit-project.php' ?>
									<!--div class="form-group form-group-sm row">
										<div class="col-xs-3"><label for="project-title" class="control-label">Title</label></div>
										<div class="col-xs-9"><input type="text" class="form-control" id="project-title" placeholder="Enter Project Title" /></div>
									</div>
